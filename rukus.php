  ...
  <body>
    ...
    <div class="container artistPage animated fadeIn">
      ...
      <div class="artist row col-md-12">
        ...
        <h1>
          <span class="artistNameToggle animated infinite pulse"><a href="noel.php"><i class="glyphicon glyphicon-menu-left"></i></a></span>
          <?php echo $page; ?>
          <span class="artistNameToggle animated infinite pulse"><a href="meia.php"><i class="glyphicon glyphicon-menu-right"></i></a></span>
        </h1>
