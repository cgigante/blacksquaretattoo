  ...
  <body>
    ...
    <div class="container artistPage">
      ...
      <div class="artist row col-md-12">
        ...
        <h1>
          <span class="artistNameToggle"><a href="meia.php"><i class="glyphicon glyphicon-menu-left"></i></a></span>
          <?php echo $page; ?>
          <span class="artistNameToggle"><a href="louis.php"><i class="glyphicon glyphicon-menu-right"></i></a></span>
        </h1>
